...
WEIGHTS_FILE = 'final_weights.h5'
ROOT_WEIGHTS_DIR = '/home/icarus/kaggle/Kaggle-Fish/model_weights'
DATA_DIR = '/home/icarus/kaggle/Kaggle-Fish/data/Final_Derived_Images/'
PRED_FILE = 'final_pred_1.csv'
PRED_TEXT = 'final_pred_1_txt.txt'
#ROOT_DATA_DIR = ''
